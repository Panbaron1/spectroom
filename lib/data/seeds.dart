...
final List<Challenge> seedChallenges = [
  ...
  Challenge(
    ...
    steps: [
      ...
      const ChallengeStep(id: 'teeth.3', kind: StepKind.info, pictogram: PictogramRef.asset('rinse'), labelCs: 'Vypláchneme pusu', labelEn: 'Rinse'),
    ],
  ),
  Challenge(
    id: 'seed.haircut',
  ...
  Challenge(
    ...
    steps: [
      ...
      const ChallengeStep(id: 'potty.7', kind: StepKind.info, pictogram: PictogramRef.asset('toilet'), labelCs: 'Spláchneme', labelEn: 'Flush'),
  ...
  Challenge(
    ...
    steps: [
      ...
      const ChallengeStep(id: 'handwash.5', kind: StepKind.info, pictogram: PictogramRef.asset('rinse'), labelCs: 'Opláchneme', labelEn: 'Rinse'),
  ...
  Challenge(
    ...
    steps: [
      const ChallengeStep(id: 'bath.fill', kind: StepKind.info, pictogram: PictogramRef.asset('faucet'), labelCs: 'Napustíme vanu', labelEn: 'Fill the tub'),
      const ChallengeStep(id: 'bath.in', kind: StepKind.info, pictogram: PictogramRef.asset('bathtub'), labelCs: 'Koupeme se', labelEn: 'Bath time'),
      const ChallengeStep(id: 'bath.play', kind: StepKind.timer, pictogram: PictogramRef.asset('bathtub'), labelCs: 'Hrajeme si ve vaně', labelEn: 'Play in the tub', durationSec: 120),
      const ChallengeStep(id: 'bath.wethair', kind: StepKind.info, pictogram: PictogramRef.asset('rinse'), labelCs: 'Namočíme vlásky', labelEn: 'Wet the hair'),
      const ChallengeStep(id: 'bath.soaphair', kind: StepKind.info, pictogram: PictogramRef.asset('soap'), labelCs: 'Namydlíme vlásky', labelEn: 'Soap the hair'),
      const ChallengeStep(id: 'bath.rinsehair', kind: StepKind.info, pictogram: PictogramRef.asset('rinse'), labelCs: 'Spláchneme vlásky', labelEn: 'Rinse the hair'),
      const ChallengeStep(id: 'bath.soapbody', kind: StepKind.info, pictogram: PictogramRef.asset('soap'), labelCs: 'Namydlíme tělíčko', labelEn: 'Soap the body'),
      const ChallengeStep(id: 'bath.rinsebody', kind: StepKind.info, pictogram: PictogramRef.asset('rinse'), labelCs: 'Opláchneme tělíčko', labelEn: 'Rinse the body'),
      const ChallengeStep(id: 'bath.dry', kind: StepKind.info, pictogram: PictogramRef.asset('towel'), labelCs: 'Osušíme se', labelEn: 'Dry off'),
      const ChallengeStep(id: 'bath.comb', kind: StepKind.info, pictogram: PictogramRef.asset('comb'), labelCs: 'Češeme vlasy', labelEn: 'Comb hair'),
      const ChallengeStep(id: 'bath.pajamas', kind: StepKind.info, pictogram: PictogramRef.asset('pajamas'), labelCs: 'Oblečeme pyžamo', labelEn: 'Put on pyjamas'),
    ],
  ),
  // ── ROUTINE ────────────────────────────────────────────────
  Challenge(
    ...
    steps: [
      ...
      const ChallengeStep(id: 'morning.7', kind: StepKind.info, pictogram: PictogramRef.asset('backpack'), labelCs: 'Batůžek připravený', labelEn: 'Pack backpack'),
  ...
  Challenge(
    ...
    steps: [
      ...
      const ChallengeStep(id: 'bedtime.hug', kind: StepKind.info, pictogram: PictogramRef.asset('hug'), labelCs: 'Objetí a pusinky', labelEn: 'Hugs and kisses'),
  ...
  Challenge(
    ...
    steps: [
      ...
      const ChallengeStep(id: 'calm.6', kind: StepKind.info, pictogram: PictogramRef.asset('hug'), labelCs: 'Objetí od maminky', labelEn: 'Hug from mum'),
